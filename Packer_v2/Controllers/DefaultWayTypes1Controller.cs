...
{
    public class DefaultWayTypes1Controller : Controller
    {
        private PackerContext db = new PackerContext();

        // GET: DefaultWayTypes1
        ...
        // GET: DefaultWayTypes1/Details/5
        ...
        // POST: DefaultWayTypes1/Delete/5
